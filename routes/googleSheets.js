...
const GOOGLE_SHEET_TIMESTAMP_COLUMN = process.env.GOOGLE_SHEET_TIMESTAMP_COLUMN || 'A';
const GOOGLE_SHEET_STOREID_COLUMN = process.env.GOOGLE_SHEET_STOREID_COLUMN || 'B';
const GOOGLE_SHEET_STORENAME_COLUMN = process.env.GOOGLE_SHEET_STORENAME_COLUMN || 'L';
const GOOGLE_SHEET_ACCOUNTSTATE_COLUMN = process.env.GOOGLE_SHEET_ACCOUNTSTATE_COLUMN || 'N';
const GOOGLE_SHEET_STOREOWNER_COLUMN = process.env.GOOGLE_SHEET_STOREOWNER_COLUMN || 'E';
const GOOGLE_SHEET_ADSADDRESS_COLUMN = process.env.GOOGLE_SHEET_ADSADDRESS_COLUMN || 'F';
const GOOGLE_SHEET_MAILBOXCOLOR_COLUMN = process.env.GOOGLE_SHEET_MAILBOXCOLOR_COLUMN || 'G';
const GOOGLE_SHEET_MANAGER_COLUMN = process.env.GOOGLE_SHEET_MANAGER_COLUMN || 'H';
const GOOGLE_SHEET_TIMESAVINGKIOSK_COLUMN = process.env.GOOGLE_SHEET_TIMESAVINGKIOSK_COLUMN || 'I';
const GOOGLE_SHEET_PRODUCTSNOTOFFERED_COLUMN = process.env.GOOGLE_SHEET_PRODUCTSNOTOFFERED_COLUMN || 'J';
const GOOGLE_SHEET_GENERALFOCUS_COLUMN = process.env.GOOGLE_SHEET_GENERALFOCUS_COLUMN || 'K';
...
const createDataRow = (formData) => {
  ...
  const columnMap = {
    ...
    [GOOGLE_SHEET_STOREID_COLUMN]: formData.storeId || '',
    ...
    [GOOGLE_SHEET_TIMESAVINGKIOSK_COLUMN]: formData.timeSavingKiosk || '',
